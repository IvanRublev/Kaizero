...
- [ ] TASK-064 An agent that calls `merge`/`mr` without first claiming the task in this session gets a distinct refusal telling it to claim first tasks/TASK-064.md
